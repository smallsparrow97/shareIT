...
public class AdminXuLyActiveSlideController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public AdminXuLyActiveSlideController() {
		super();
	}
